  ...
  (self["webpackChunkseller_app"] = self["webpackChunkseller_app"] || []).push([["src_app_addoffer-edit_addoffer-edit_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddofferEditPageRoutingModule": function AddofferEditPageRoutingModule() {
          return (
            /* binding */
            _AddofferEditPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _addoffer_edit_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./addoffer-edit.page */
      65776);
      ...
      var _AddofferEditPageRoutingModule = function AddofferEditPageRoutingModule() {
        _classCallCheck(this, AddofferEditPageRoutingModule);
      };

      _AddofferEditPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddofferEditPageModule": function AddofferEditPageModule() {
          return (
            /* binding */
            _AddofferEditPageModule
          );
        }
        /* harmony export */
      ...
      var _addoffer_edit_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./addoffer-edit-routing.module */
      52444);
      /* harmony import */


      var _addoffer_edit_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./addoffer-edit.page */
      65776);

      var _AddofferEditPageModule = function AddofferEditPageModule() {
        _classCallCheck(this, AddofferEditPageModule);
      };

      _AddofferEditPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _addoffer_edit_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddofferEditPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddofferEditPage": function AddofferEditPage() {
          return (
            /* binding */
            _AddofferEditPage
          );
      ...
      var _raw_loader_addoffer_edit_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./addoffer-edit.page.html */
      12529);
      /* harmony import */


      var _addoffer_edit_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./addoffer-edit.page.scss */
      97446);
      /* harmony import */
      ...
      var _AddofferEditPage = /*#__PURE__*/function () {
        function AddofferEditPage(http, router, route) {
          var _this = this;

          _classCallCheck(this, AddofferEditPage);
          ...
          route.params.subscribe(function (val) {
            ...
            _this.getProductList(); //this.getsubCategoryList()
        ...
        _createClass(AddofferEditPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "backAddoffer",
          value: function backAddoffer() {
          ...
          value: function getCategoryList() {
            ...
            this.http.get('/read_all_category').subscribe(function (response) {
              _this2.categoryList = response.records;
          ...
          key: "gettBid",
          value: function gettBid() {
            var _this3 = this;

            this.route.queryParams.subscribe(function (params) {
              console.log(params.tbid);
              _this3.tbid_value = params.tbid;
            });
          }
        }, {
          key: "readOneOffer",
          value: function readOneOffer() {
            var _this4 = this;

            this.http.get('/read_one_offer?o=' + this.tbid_value).subscribe(function (response) {
              _this4.description = response.records.description;
              _this4.Category = response.records.category;
              _this4.subcategory = response.records.subcategory;
              _this4.productName = response.records.product;
              _this4.offer = response.records.offer;
              _this4.otheroffer = response.records.other_offer;
              ...
              _this4.tbid = response.records.tbid;
            }, function (error) {
              console.log(error);
            });
          }
          ...
          value: function popupModel(data) {
            ...
            var c = data.category;
            this.http.get('/read_one_category?c=' + c).subscribe(function (response) {
              _this5.category_tbid = response.records.tbid;
          ...
          value: function categorysubmit() {
            ...
            this.http.post('/read_subcategory', obj).subscribe(function (response) {
              console.log(response.records);
              _this6.subcategoryList = response.records;
              console.log(_this6.subcategoryList);
              _this6.subCategoryNotfound = false;
            }, function (error) {
              console.log(error);
              _this6.subCategoryNotfound = true;
              _this6.subcategoryList = [];
            });
          }
        }, {
          key: "offerDelete",
          value: function offerDelete() {
            var obj = {
              tbid: this.tbid_value
            };
            this.http.post('/delete_offer', obj).subscribe(function (response) {
          ...
          value: function getProductList() {
            ...
            this.http.get('/read_all_product').subscribe(function (response) {
              _this7.productList = response.records;
              console.log(response.records);
            }, function (error) {
              console.log(error);
            });
          ...
          value: function addoffer() {
            ...
            this.http.post('/update_offer', productData).subscribe(function (response) {
              console.log(response);
              ...
              if (response.success == "true") {
                ...
                _this8.router.navigate(['/tabs/tab4']);
              }
            }, function (error) {
              console.log(error);
            });
          ...
          key: "hideaddnewcategorypopup",
          value: function hideaddnewcategorypopup() {
            this.addnewcategorypopup = false;
          }
        }, {
          key: "showaddnewcategorypopup",
          value: function showaddnewcategorypopup() {
            this.addnewcategorypopup = true;
          }
        }, {
          key: "showaddnewsubcategorypopup",
          value: function showaddnewsubcategorypopup() {
            this.addnewsubcategorypopup = true;
          }
        }, {
          key: "hideaddnewsubcategorypopup",
          value: function hideaddnewsubcategorypopup() {
            this.addnewsubcategorypopup = false;
          }
        }, {
          key: "subcategorysubmit",
          value: function subcategorysubmit(value) {
            var _this9 = this;

            console.log(value.subcategory);
            this.subcategory = value.subcategory;
            var s = value.subcategory;
            this.http.get('/read_one_subcategory?s=' + s).subscribe(function (response) {
              _this9.subcategory_tbid = response.records.tbid;
            }, function (error) {
              console.log(error);
            });
          }
        }, {
          key: "showaddproductpopup",
          value: function showaddproductpopup() {
            this.addnewproductpopup = true;
          }
        }, {
          key: "hideaddproductpopup",
          value: function hideaddproductpopup() {
            this.addnewproductpopup = false;
          }
        }, {
          key: "productselectform",
          value: function productselectform(value) {
            var _this10 = this;

            this.productName = value.productName;
            console.log(this.productName);
            var p = this.productName;
            this.http.get('/read_one_product?p=' + p).subscribe(function (response) {
              _this10.product_tbid = response.records.tbid;
              console.log(_this10.product_tbid);
            }, function (error) {
              console.log(error);
            });
          }
        ...
        return AddofferEditPage;
      }();

      _AddofferEditPage.ctorParameters = function () {
        return [{
      ...
      _AddofferEditPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
...
//# sourceMappingURL=src_app_addoffer-edit_addoffer-edit_module_ts-es5.js.map