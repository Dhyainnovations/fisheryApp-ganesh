    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _MyproductEditPage = /*#__PURE__*/function () {
        ...
        _createClass(MyproductEditPage, [{
          key: "LoadReadData",
          value: function LoadReadData() {
            var _this2 = this;

            this.route.queryParams.subscribe(function (params) {
              //console.log(params.product_name);
              _this2.product_name = params.product_name;
              _this2.tbid_value = params.tbid;
            });
          }
        }, {
          key: "ngOnInit",
          ...
          value: function popupModel(data) {
            ...
            this.http.get('/read_one_category?c=' + c).subscribe(function (response) {
              _this3.category_tbid = response.records.tbid;
          ...
          key: "appendReadData",
          value: function appendReadData() {
            var _this4 = this;

            var p = this.product_name; //console.log(p);
            ...
            this.http.get('/read_one_product?p=' + p).subscribe(function (response) {
              ...
              _this4.cost = response.records.cost;
              _this4.DisplayImage = response.records.product_image;
          ...
          value: function onClickSubmit(data) {
            ...
            formdata.append("weight", data.weight); // console.log('formData: ', formdata.getAll('category'), formdata.getAll('product_image'));
            ...
            this.http.postFormData("/update_product", formdata).subscribe(function (response) {
              ...
              _this5.router.navigate(['/myproducts']);
            }, function (error) {
              console.log(error);
            });
          }
          ...
          value: function deleteProduct() {
            ...
            this.http.post('/delete_product', obj).subscribe(function (response) {
              //console.log(response);
              if (response.success == "true") {
                ...
                _this6.router.navigate(['/myproducts']);
              }
          ...
          value: function getUnit() {
            ...
            this.http.get('/read_unit').subscribe(function (response) {
              //console.log(response.records);
              _this8.readunit = response.records;
            }, function (error) {//console.log(error);
            });
          }
        }, {
          ...
          value: function createSubcategory() {
            ...
            this.http.post('/create_subcategory', subcatData).subscribe(function (response) {
              ...
              if (response.success == "true") {
                ...
                _this9.Category = '';
                _this9.subcategory = '';
                _this9.subcategoryName = ''; //this.getSubcategoryList()
              }
            }, function (error) {
              console.log(error);
            });
          ...
          value: function getCategoryList() {
            ...
            this.http.get('/read_all_category').subscribe(function (response) {
              //console.log(response.records);
              _this10.categoryList = response.records;
              console.log(response.records); //console.log(this.categoryList);
            }, function (error) {//console.log(error);
            });
          } // getSubcategoryList() {
          ...
          value: function showPopup() {
            ...
            this.isvisible = true;
            this.http.get('/product_image_list').subscribe(function (response) {
              console.log(response);
              _this11.showProducts = response.records;
            }, function (error) {
              console.log(error);
            });
          }
          ...
          value: function categorysubmit() {
            ...
            this.http.post('/read_subcategory', obj).subscribe(function (response) {
              console.log(response.records);
              _this12.subcategoryList = response.records;
              console.log(_this12.subcategoryList);
              _this12.subCategoryNotfound = false;
            }, function (error) {
              console.log(error);
              _this12.subCategoryNotfound = true;
              _this12.subcategoryList = [];
            });
          }
        }, {
          ...
          value: function subcategorysubmit(value) {
            ...
            this.http.get('/read_one_subcategory?s=' + s).subscribe(function (response) {
              _this13.subcategory_tbid = response.records.tbid;
            }, function (error) {
              console.log(error);
            });
          }
      ...
      _MyproductEditPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
