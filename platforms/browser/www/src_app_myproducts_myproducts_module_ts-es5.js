  ...
  (self["webpackChunkseller_app"] = self["webpackChunkseller_app"] || []).push([["src_app_myproducts_myproducts_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyproductsPageRoutingModule": function MyproductsPageRoutingModule() {
          return (
            /* binding */
            _MyproductsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _myproducts_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./myproducts.page */
      6329);
      ...
      var _MyproductsPageRoutingModule = function MyproductsPageRoutingModule() {
        _classCallCheck(this, MyproductsPageRoutingModule);
      };

      _MyproductsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyproductsPageModule": function MyproductsPageModule() {
          return (
            /* binding */
            _MyproductsPageModule
          );
        }
        /* harmony export */
      ...
      var _myproducts_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./myproducts-routing.module */
      61441);
      /* harmony import */


      var _myproducts_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./myproducts.page */
      6329);

      var _MyproductsPageModule = function MyproductsPageModule() {
        _classCallCheck(this, MyproductsPageModule);
      };

      _MyproductsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _myproducts_routing_module__WEBPACK_IMPORTED_MODULE_0__.MyproductsPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyproductsPage": function MyproductsPage() {
          return (
            /* binding */
            _MyproductsPage
          );
      ...
      var _raw_loader_myproducts_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./myproducts.page.html */
      89238);
      /* harmony import */


      var _myproducts_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./myproducts.page.scss */
      25961);
      /* harmony import */
      ...
      var _MyproductsPage = /*#__PURE__*/function () {
        function MyproductsPage(http, router, route) {
          var _this = this;

          _classCallCheck(this, MyproductsPage);
        ...
        _createClass(MyproductsPage, [{
          ...
          value: function ProductList() {
            ...
            this.http.get('/read_all_product').subscribe(function (response) {
              _this2.productlist = response.records;
            }, function (error) {
              console.log(error);
            });
          }
          ...
          key: "editDetails",
          value: function editDetails(product_name) {
            var _this3 = this;

            var p = product_name;
            console.log(p);
            this.http.get('/read_one_product?p=' + p).subscribe(function (response) {
              _this3.displayReadData = response.records.tbid;
              _this3.showReadData = response.records.product_name;

              _this3.router.navigate(['/myproductEditPage'], {
                queryParams: {
                  tbid: _this3.displayReadData,
                  product_name: _this3.showReadData
                }
              });
            }, function (error) {
              console.log(error);
      ...
      _MyproductsPage.ctorParameters = function () {
        return [{
      ...
      _MyproductsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
...
//# sourceMappingURL=src_app_myproducts_myproducts_module_ts-es5.js.map